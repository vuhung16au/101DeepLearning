...
\objective{Variational inference and sampling-based approaches}
\objective{ELBO objectives and coordinate ascent updates for simple models}
\objective{Amortized inference and its benefits and limitations}
\objective{Approximation quality using diagnostics and bounds}
...
\input{chapters/chap19-exercises}
