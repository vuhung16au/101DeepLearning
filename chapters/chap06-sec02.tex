...
\begin{definition}[Parametric ReLU (PReLU)]
\begin{equation}
...
\begin{definition}[Exponential Linear Unit (ELU)]
\begin{equation}
...
\begin{definition}[Swish Activation Function]
...
\begin{definition}[Gaussian Error Linear Unit (GELU)]
