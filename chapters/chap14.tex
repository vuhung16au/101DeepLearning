...
\objective{Autoencoder framework and common variants (denoising, sparse, contractive)}
\objective{Role of bottlenecks and regularization in learning useful representations}
\objective{Training objectives and reconstruction vs. downstream utility evaluation}
\objective{Connection between autoencoders and generative models}
