...
\begin{definition}[Condition Number for Symmetric Matrices]
...
\begin{example}[Well-Conditioned vs Ill-Conditioned Matrices]
...
\begin{remark}[Mixed Precision Training and Quantization]
