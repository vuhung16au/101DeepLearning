...
For multiple random variables $X$ and $Y$, the joint distribution $P(X, Y)$ describes their combined behavior, specifying the probability of all possible combinations of values for both variables.
\end{definition}

\begin{definition}[Marginal Distribution]
The marginal distribution is obtained by summing (or integrating) over the other variable, giving us the probability distribution of a single variable when we ignore the others:
