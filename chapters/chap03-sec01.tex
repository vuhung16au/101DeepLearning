...
\end{axis}
\end{tikzpicture}
\caption{Two normal distributions: $\mathcal{N}(0,1)$ (purple) and $\mathcal{N}(0.5,0.5)$ (red).}
...
\end{axis}
\end{tikzpicture}
\caption{Cumulative probability: shaded area under $f(x)$ represents $P(X \leq a)$ for normal distribution.}
