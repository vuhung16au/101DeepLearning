...
\objective{Supervised, self-supervised, and contrastive objectives}
\objective{Representations via linear probes and transfer learning}
\objective{Information-theoretic perspectives to empirical practice}
