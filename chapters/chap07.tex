...
\objective{Norm penalties (L1, L2, Elastic Net) and when to use each}
\objective{Data augmentation strategies for vision, text, and audio tasks}
\objective{Early stopping and its interaction with optimization}
\objective{Dropout and normalization layers and their effects}
\objective{Advanced techniques: label smoothing, mixup, adversarial training, and gradient clipping}
