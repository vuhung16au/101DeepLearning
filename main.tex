...
% --- Custom Color Scheme ---
% Primary Colors
\definecolor{bookpurple}{RGB}{60,16,83}      % Main purple accent (Hex: #3C1053)
\definecolor{bookred}{RGB}{242,18,12}        % Red for citations (Hex: #F2120C)
\definecolor{bookblack}{RGB}{0,0,0}          % Standard black (Hex: #000000)
\definecolor{bookwhite}{RGB}{255,255,255}    % Standard white (Hex: #FFFFFF)

% Secondary Colors
\definecolor{lawpurple}{RGB}{181,24,37}      % Faculty of Law and Business (Hex: #B51825)
\definecolor{warmstone}{RGB}{145,139,131}    % Warm Stone neutral (Hex: #918B83)
\definecolor{deepcharcoal}{RGB}{48,44,42}    % Deep Charcoal dark neutral (Hex: #302C2A)
\definecolor{softivory}{RGB}{242,239,235}    % Soft Ivory light background (Hex: #F2EFEB)
...
% --- Headers and Footers ---
\usepackage{fancyhdr}
% Read version string from version.txt if present
\newcommand{\bookversion}{\IfFileExists{version.txt}{\input{version.txt}}{v1.0.0}}
% Project URL for footer
\newcommand{\bookurl}{https://vuhung16au.github.io/}
...
% --- Exercise Boxes ---
% Define color scheme for exercise difficulty levels
\definecolor{easycolor}{RGB}{232,245,233}      % Light green for easy exercises
\definecolor{mediumcolor}{RGB}{227,242,253}    % Light blue for medium exercises
\definecolor{hardcolor}{RGB}{255,235,238}      % Light red/pink for hard exercises

% Define exercise box environment with difficulty-based color coding
...
% Define colors for theorem boxes (matching book color scheme)
\colorlet{theoremblue}{bookpurple!80}
\colorlet{theoremgray}{softivory}
\colorlet{definitionblue}{bookpurple!70}

% Define theorem box style (for theorems, lemmas, propositions, corollaries)
...
% Define definition box style (for definitions, examples)
...
% Define remark style (subtle, minimal styling)
...
% Create theorem-like environments with shared counter
...
% Define definition-like environments (sharing counter with theorems)
...
% Define remark (sharing counter with theorems)
\newkeytheorem{remark}[
  sibling=theorem,
  style=remarkbox,
  ]

% Define proof environment (non-numbered) only if not already defined by amsthm
\makeatletter
\@ifundefined{proof}{%
  \newkeytheorem{proof}[
    style=proofbox,
...
% Define problem/exercise with separate counter
...
% Define colors for learning objectives
\definecolor{objbg}{RGB}{248,249,250}     % Light background (legacy)
\definecolor{objborder}{RGB}{74,144,226}  % Blue border (legacy)
\definecolor{objtext}{RGB}{33,37,41}      % Dark text (legacy)
% Use new color scheme for learning objectives
\colorlet{objbg}{softivory}
\colorlet{objborder}{bookpurple}
\colorlet{objtext}{deepcharcoal}

% Custom command for individual objectives
\newcommand{\objective}[1]{%
  \item \textcolor{objtext}{#1}
}
...
\newenvironment{learningobjectives}{%
  \begin{tcolorbox}[
    ...
    title={\textcolor{objborder}{🎯} Learning Objectives}
  ]
